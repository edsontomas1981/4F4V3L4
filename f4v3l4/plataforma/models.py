...
class Mensagens (models.Model):
    ...
    userRem_fk=models.ForeignKey(Usuarios,related_name='remetente',null=False,on_delete=models.CASCADE)
    userDest_fk=models.ForeignKey(Usuarios,related_name='destinatario',null=False,on_delete=models.CASCADE)
